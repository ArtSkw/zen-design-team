...
export const TEAM: Member[] = [
  // ---- designed ------------------------------------------------------------
  {
    ...
    temperament: { breath: 1.0, blink: 1.0, sway: 1.0 }, quote: '',
  },
  {
    ...
    temperament: { breath: 0.9, blink: 1.1, sway: 0.9 }, quote: '',
  },
  {
  ...
  },
  {
    ...
    seat: at(3.0, 0, 2.6, 1.0), temperament: { breath: 1.0, blink: 0.95, sway: 1.15 }, quote: '',
  },
  { id: 'mirek', name: 'Mirek', seed: 73, parts: [], seat: at(5.0, 0, 1.9, -0.3), temperament: { breath: 1.2, blink: 1.0, sway: 0.9 }, quote: '' },
  {
    ...
    seat: at(14.6, STONE, 5.3, 0.15), temperament: { breath: 0.9, blink: 1.15, sway: 1.0 }, quote: '',
  },
  {
    ...
    seat: at(11.1, 0, 7.3, 0.5), temperament: { breath: 1.05, blink: 1.0, sway: 1.05 }, quote: '',
  },
]
